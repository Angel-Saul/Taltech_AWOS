# BRs (Business Rules)  ![Word]

En esta sección se encontrarán las reglas de negocio de TALTECH.
...
|Luis Felipe Cazarez Marquez|[@xluiscm](https://github.com/)|Desarrollador de backend|Revisado.|
